...
class AppSyncFunctionConfiguration extends constructs_1.Construct {
    constructor(scope, id, props) {
        ...
        this.function = new aws_appsync_1.CfnFunctionConfiguration(this, `${id}.AppSyncFunction`, {
            ...
            dataSourceName: props.dataSource instanceof aws_appsync_alpha_1.BaseDataSource ? props.dataSource.ds.attrName : props.dataSource,
        ...
        if (props.dataSource instanceof aws_appsync_alpha_1.BackedDataSource) {
