...
exports.adoptAuthMode = exports.adoptAuthModes = exports.IAM_UNAUTH_ROLE_PARAMETER = exports.IAM_AUTH_ROLE_PARAMETER = void 0;
const aws_appsync_alpha_1 = require("@aws-cdk/aws-appsync-alpha");
const aws_cognito_1 = require("aws-cdk-lib/aws-cognito");
const aws_cdk_lib_1 = require("aws-cdk-lib");
const authTypeMap = {
    API_KEY: aws_appsync_alpha_1.AuthorizationType.API_KEY,
    AMAZON_COGNITO_USER_POOLS: aws_appsync_alpha_1.AuthorizationType.USER_POOL,
    AWS_IAM: aws_appsync_alpha_1.AuthorizationType.IAM,
    OPENID_CONNECT: aws_appsync_alpha_1.AuthorizationType.OIDC,
    AWS_LAMBDA: "AWS_LAMBDA",
};
exports.IAM_AUTH_ROLE_PARAMETER = 'authRoleName';
exports.IAM_UNAUTH_ROLE_PARAMETER = 'unauthRoleName';
...
function adoptAuthMode(stackManager, entry) {
    ...
    switch (entry.authenticationType) {
        case aws_appsync_alpha_1.AuthorizationType.API_KEY:
            return {
        ...
        case aws_appsync_alpha_1.AuthorizationType.USER_POOL:
        ...
        case aws_appsync_alpha_1.AuthorizationType.IAM:
            return {
                authorizationType: authType,
            };
        case aws_appsync_alpha_1.AuthorizationType.OIDC:
            return {
                authorizationType: authType,
                openIdConnectConfig: {
