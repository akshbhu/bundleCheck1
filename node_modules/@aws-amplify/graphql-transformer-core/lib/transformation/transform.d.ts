import { AppSyncAuthConfiguration, DeploymentResources, FeatureFlagProvider, Template, TransformerPluginProvider, TransformHostProvider } from '@aws-amplify/graphql-transformer-interfaces';
