...
class GraphQLTransform {
    constructor(options) {
        ...
        this.applyOverride = (stackManager) => {
            ...
            const overrideCode = fs.readFileSync(overrideFilePath, 'utf-8');
    ...
    generateGraphQlApi(stackManager, output) {
        ...
        if (authModes.includes(aws_appsync_alpha_1.AuthorizationType.API_KEY) && !hasLegacyAPIKeyConfigDisabled) {
            const apiKeyConfig = [
                authorizationConfig.defaultAuthorization,
                ...(authorizationConfig.additionalAuthorizationModes || []),
            ].find(auth => (auth === null || auth === void 0 ? void 0 : auth.authorizationType) == aws_appsync_alpha_1.AuthorizationType.API_KEY);
            ...
            new aws_cdk_lib_1.CfnOutput(rootStack, 'GraphQLAPIKeyOutput', {
        ...
        new aws_cdk_lib_1.CfnOutput(rootStack, 'GraphQLAPIIdOutput', {
            value: api.apiId,
            description: 'Your GraphQL API ID.',
            exportName: aws_cdk_lib_1.Fn.join(':', [aws_cdk_lib_1.Aws.STACK_NAME, 'GraphQLApiId']),
        });
        new aws_cdk_lib_1.CfnOutput(rootStack, 'GraphQLAPIEndpointOutput', {
