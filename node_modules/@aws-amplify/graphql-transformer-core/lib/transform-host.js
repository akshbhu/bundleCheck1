...
class DefaultTransformHost {
    ...
    doAddNoneDataSource(id, options, stack) {
        return new aws_appsync_alpha_1.NoneDataSource(stack !== null && stack !== void 0 ? stack : this.api, id, {
            api: this.api,
    ...
    doAddDynamoDbDataSource(id, table, options, stack) {
        const ds = new aws_appsync_alpha_1.DynamoDbDataSource(stack !== null && stack !== void 0 ? stack : this.api, id, {
            api: this.api,
            table,
            name: options === null || options === void 0 ? void 0 : options.name,
            description: options === null || options === void 0 ? void 0 : options.description,
    ...
    doAddHttpDataSource(id, endpoint, options, stack) {
        const ds = new aws_appsync_alpha_1.HttpDataSource(stack !== null && stack !== void 0 ? stack : this.api, id, {
            api: this.api,
            endpoint,
            name: options === null || options === void 0 ? void 0 : options.name,
            description: options === null || options === void 0 ? void 0 : options.description,
    ...
    doAddLambdaDataSource(id, lambdaFunction, options, stack) {
        const ds = new aws_appsync_alpha_1.LambdaDataSource(stack || this.api, id, {
            api: this.api,
            lambdaFunction,
            name: options === null || options === void 0 ? void 0 : options.name,
            description: options === null || options === void 0 ? void 0 : options.description,
