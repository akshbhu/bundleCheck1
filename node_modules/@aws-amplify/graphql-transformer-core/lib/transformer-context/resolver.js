...
class TransformerResolver {
                ...
                switch (dataSourceType) {
                    ...
                    case 'RELATIONAL_DATABASE':
                        if (this.datasource.ds.relationalDatabaseConfig
                            ...
                            && !(0, aws_cdk_lib_1.isResolvableObject)((_f = this.datasource.ds.relationalDatabaseConfig) === null || _f === void 0 ? void 0 : _f.rdsHttpEndpointConfig)) {
    ...
    `;
            ...
            if (authModes.includes(aws_appsync_alpha_1.AuthorizationType.IAM)) {
      ...
      $util.qr($ctx.stash.put("authRole", "arn:aws:sts::${aws_cdk_lib_1.Stack.of(context.stackManager.rootStack).account}:assumed-role/${authRoleParameter}/CognitoIdentityCredentials"))
      $util.qr($ctx.stash.put("unauthRole", "arn:aws:sts::${aws_cdk_lib_1.Stack.of(context.stackManager.rootStack).account}:assumed-role/${unauthRoleParameter}/CognitoIdentityCredentials"))
      `;
            }
            initResolver += '\n$util.toJson({})';
