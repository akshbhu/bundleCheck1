...
class StackManager {
    constructor(app, resourceMapping) {
        ...
        this.createStack = (stackName) => {
            const synthesizer = new cdk_compat_1.TransformerStackSythesizer();
        ...
        this.addParameter = (name, props) => {
            const param = new aws_cdk_lib_1.CfnParameter(this.rootStack, name, props);
            this.paramMap.set(name, param);
            return param;
        };
        this.getParameter = (name) => this.paramMap.get(name);
