...
const nodeErrorToAmplifyException = (err) => new amplify_cli_core_1.AmplifyFault(nodeErrorTypeToAmplifyExceptionType(), {
    message: err.message,
    resolution: mapNodeErrorToResolution(err),
    code: err.code,
}, err);
const nodeErrorTypeToAmplifyExceptionType = () => 'UnknownNodeJSFault';
const mapNodeErrorToResolution = (err) => {
    if (!(0, amplify_cli_core_1.isWindowsPlatform)() && err.code === 'EACCES' && err.message.includes('/.amplify/')) {
...
const mapGenericErrorToResolution = () => `Please report this issue at https://github.com/aws-amplify/amplify-cli/issues and include the project identifier from: 'amplify diagnose --send-report'`;
const unknownErrorTypeToAmplifyExceptionType = () => 'UnknownFault';
const mapUnknownErrorToResolution = () => `Please report this issue at https://github.com/aws-amplify/amplify-cli/issues and include the project identifier from: 'amplify diagnose --send-report'`;
