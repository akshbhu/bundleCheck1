...
const transformer_factory_1 = require("../graphql-transformer/transformer-factory");
    ...
    constructor() {
        ...
        this.readSchema = async (context, options, usePreProcessing = true) => {
            ...
            if (preProcessSchema && !this.preProcessedSchemaDocument) {
                ...
                const transform = await (0, transformer_factory_1.constructGraphQLTransformV2)(transformerOptions);
