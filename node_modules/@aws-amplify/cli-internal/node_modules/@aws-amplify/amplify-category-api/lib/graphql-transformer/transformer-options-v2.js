...
exports.generateTransformerOptions = exports.APPSYNC_RESOURCE_SERVICE = void 0;
...
const generateTransformerOptions = async (context, options) => {
    ...
    const adminRoles = await (0, utils_1.getAdminRoles)(context, resourceName);
    const identityPoolId = await (0, utils_1.getIdentityPoolId)(context);
    ...
    const transformerListFactory = await (0, transformer_factory_1.getTransformerFactory)(context, resourceDir);
    (0, api_utils_1.searchablePushChecks)(context, directiveMap.types, parameters[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AppSyncApiName]);
