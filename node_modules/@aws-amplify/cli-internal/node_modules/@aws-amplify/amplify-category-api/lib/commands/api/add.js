...
const run = async (context) => {
    const servicesMetadata = (await Promise.resolve().then(() => __importStar(require(path.join('..', '..', 'provider-utils', 'supported-services'))))).supportedServices;
    return context.amplify
        ...
        const providerController = await Promise.resolve().then(() => __importStar(require(path.join('..', '..', 'provider-utils', result.providerName, 'index'))));
