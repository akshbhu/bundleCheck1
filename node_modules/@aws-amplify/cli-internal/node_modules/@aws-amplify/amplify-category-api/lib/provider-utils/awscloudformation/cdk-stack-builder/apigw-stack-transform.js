...
exports.ApigwStackTransform = void 0;
...
class ApigwStackTransform {
    ...
    async applyOverrides() {
        ...
        if (isBuild) {
            let override;
            try {
                ({ override } = await Promise.resolve().then(() => __importStar(require(overrideJSFilePath))));
            }
            catch (_a) {
                amplify_prompts_1.formatter.list(['No override file found', `To override ${this.resourceName} run "amplify override api"`]);
                override = undefined;
            }
